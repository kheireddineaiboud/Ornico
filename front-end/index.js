...
function addCards(data) {
    ...
    for (produit of data) {
        //recupère l'élément card_list dans le HTML
        const card = document.getElementById("card_list");
        //convertit le prix
        const price = convertPrice(produit.price);
        card.innerHTML += `
        <div class="col-sm-12 col-md-6 col-lg-6 pb-3  ">
            <div class="card-all card border bg-light shadow p-3 mb-5 bg-body rounded">
                <div class="card-body">
                    <div class="row">
                    ...
                    <a href="produit.html?_id=${produit._id}" class="btn btn-secondary btn-acht">Acheter ce produit</a>
                </div>
            </div>
        </div>`;
    }
